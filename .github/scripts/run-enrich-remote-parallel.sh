...
source <(grep -E '^(SUPABASE_URL|NEXT_PUBLIC_SUPABASE_URL|SUPABASE_SERVICE_ROLE_KEY|SUPABASE_KEY|GEMINI_API_KEY|GEMINI_API_KEY_[0-9]|GROQ_API_KEY|GROQ_API_KEY_[0-9]|OPENAI_API_KEY|COHERE_API_KEY|COHERE_API_KEY_[0-9]|ANTHROPIC_API_KEY)=' .env.local | sed 's/"//g')
set +a

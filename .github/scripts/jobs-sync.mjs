...
const GREENHOUSE_SLUGS = [
  '10beauty', '10xgenomics', '1uphealth', '2k', '2k', '5wpr', '6sense', 'a16z', 'abcellera', 'abelsontaylor', 'able', 'abnormalsecurity', 'absci', 'accuweather', 'aceable', 'acquia', 'acuitymd', 'acumen', 'adahealth', 'adaptivebiotechnologies', 'addepar1', 'adyen', 'adzuna', 'affinipay', 'affinitiv', 'affirm', 'afresh', 'afresh', 'aftership', 'ageoflearninginc', 'agero', 'agero', 'agoda', 'airbnb', 'airship', 'airtable', 'aisi', 'aiviq', 'akunacapital', 'akunacapital', 'alayacare', 'alertmedia', 'algolia', 'allegro', 'alloy', 'alloy', 'alpaca', 'alphasights', 'altanaai', 'altruist', 'amount', 'amperity', 'amplemarket', 'amplitude', 'anaplan', 'anthropic', 'apollo', 'apolloio', 'appian', 'applecart', 'applovin', 'appsflyer', 'apptronik', 'aptoslabs', 'aqr', 'aquaticcapitalmanagement', 'arcadiacareers', 'arizeai', 'asana', 'assemblyai', 'assetliving', 'astranis', 'astranis', 'athinkingape', 'attain', 'attentive', 'augury', 'aura', 'australia', 'auterion', 'automox', 'autoscout24', 'aviatrix', 'axios', 'b12', 'babylist', 'bandainamco', 'bandwidth', 'bark', 'baton', 'beautifulai', 'berlinrosen', 'betterment', 'billcom', 'billiontoone', 'binance', 'bird', 'bitgo', 'bitly', 'bitmex', 'bitpanda', 'bitso', 'bitwarden', 'blackedgecapital', 'blackforestlabs', 'blankstreet', 'blend', 'block', 'blockchain', 'bloomworks', 'bluehaveninitiative', 'bluehole', 'bombas', 'bondvet', 'boomilp', 'boulevard', 'bracebridgecapital', 'brainpop', 'branch', 'branchmetrics', 'brave', 'braze', 'breezeairways', 'brex', 'bringg', 'broadsign', 'brooklinen', 'bugcrowd', 'builder', 'buildkite', 'buildops', 'builtin', 'bulgaria', 'businessolver', 'butterflynetwork', 'buzzfeed', 'bybit', 'c3iot', 'c6bank', 'cabify', 'cabin', 'cais', 'calendly', 'calm', 'cameo', 'candidly', 'canonical', 'capitolis', 'carbon', 'careem', 'cargurus', 'caribou', 'carrotfertility', 'carta', 'cartahealthcare', 'carvana', 'catonetworks', 'cbinsights', 'cbinsights', 'censys', 'cerebral', 'cerebrassystems', 'chargepoint', 'chartbeatinc', 'checkr', 'cheddar', 'chile', 'chime', 'cie', 'circ', 'circleci', 'civisanalytics', 'clara', 'clarifai', 'classpass', 'clear', 'clearstreet', 'cleo', 'clever', 'clickhouse', 'climatex', 'cloudflare', 'cloverhealth', 'cloverly', 'clutch', 'coactive', 'coalition', 'coast', 'cockroachlabs', 'codex', 'cognism', 'cognite', 'cognitiv', 'coherusbiosciences', 'coinbase', 'collectivehealth', 'collibra', 'colossalbiosciences', 'commercetools', 'community', 'complyadvantage', 'conga', 'consensys', 'contentful', 'contextualai', 'convene', 'corelight', 'corescientific', 'coreweave', 'cornerstone', 'coterieinsurance', 'couchbaseinc', 'coursera', 'crayon', 'creativex', 'credible', 'cresta', 'crexi', 'cribl', 'criticalmass', 'crm', 'crowdstreet', 'crunchyroll', 'cts', 'cultureamp', 'curaleaf', 'curative', 'customerio', 'cuyana', 'cybereason', 'cypressio', 'd2l', 'd3', 'dagger', 'databricks', 'datacamp', 'datadog', 'datagrail', 'datagrail', 'dataiku', 'dataiku', 'datarails', 'dealpath', 'deepmind', 'degreed', 'descript', 'developmentseed', 'devrev', 'dialpad', 'digible', 'digimarc', 'digitalocean98', 'digitalservice', 'diligentrobotics', 'diligentrobotics', 'disco', 'discord', 'disney', 'dispatch', 'distrokid', 'doctolib', 'docugami', 'dollarshaveclub', 'doma', 'dominodatalab', 'doordashcanada', 'doordashusa', 'doubleverify', 'doximity', 'drivewealth', 'dropbox', 'druva', 'dscout', 'ducerapartners', 'duolingo', 'dyopath', 'earnin', 'ebanx', 'eh2', 'elastic', 'elementbiosciences', 'elend', 'elsevier', 'elwoodtechnologies', 'emarketer', 'embroker', 'emplifi', 'enova', 'enova', 'enterpret', 'epicgames', 'epirus', 'equalexperts', 'equityzen', 'ethic', 'ethoslife', 'eucalyptus', 'eve', 'everlane', 'everlaw', 'exiger', 'exoduspoint', 'extend', 'faire', 'fairmarkit', 'falconx', 'falconx', 'fandom', 'fanduel', 'fanduel', 'fareharbor', 'fastly', 'federato', 'feedzai', 'fender', 'fermat', 'fictiv', 'figma', 'figment', 'figureai', 'filecoinfoundation', 'finitestate', 'fireblocks', 'firesprite', 'fireworksai', 'five9', 'fivetran', 'flagshippioneeringinc', 'flatironhealth', 'fleetio', 'flex', 'flexe', 'flexport', 'flickr', 'flohealth', 'flourish', 'flowtraders', 'flygreen', 'forbes', 'form3', 'formhealth', 'formic', 'formlabs', 'formlabs', 'forter', 'forward', 'foundenergy', 'founders', 'fourkites', 'freenome', 'fubotv', 'fuga', 'galaxy', 'galaxydigitalservices', 'garnerhealth', 'gather', 'gatherai', 'gemini', 'gener8tor', 'generalassembly', 'generalatlantic', 'generatebiomedicines', 'genesis', 'genius', 'getyourguide', 'ghost', 'ginkgobioworks', 'gitlab', 'glance', 'glance', 'glassdoor', 'gleanwork', 'gleanwork', 'glossgenius', 'glossier', 'goatgroup', 'gocardless', 'godaddy', 'gofundme', 'goguardian', 'goldenhippo', 'gostudent', 'govtech', 'grafanalabs', 'grailed', 'gramgames', 'graphcore', 'greenhouse', 'grin', 'groupon', 'grovecollaborative', 'grover', 'groww', 'guidepoint', 'gumgum', 'gusto', 'gympass', 'gymshark', 'hackerrank', 'happymoney', 'helium', 'hellofresh', 'hextechnologies', 'heycar', 'heygen', 'highnote', 'highradius', 'hive', 'hologram', 'homechef', 'homelight', 'hometap', 'homeward', 'honeycomb', 'hootsuite', 'hopskipdrive', 'housemarque', 'hubspot', 'hubspotjobs', 'hudl', 'humaninterest', 'humansignal', 'humeai', 'huntress', 'hypr', 'icon', 'ideo', 'idme', 'ifit', 'ignition', 'iherb', 'imgur', 'immunefi', 'imubit', 'inbank', 'india', 'indigo', 'inflectionai', 'infosum', 'ingenio', 'inkind', 'inmobi', 'innovid', 'inspire11', 'inspiren', 'instabase', 'instabase', 'instacart', 'insurify', 'intercom', 'interstellarlab', 'intersystems', 'invoca', 'ionq', 'ireland', 'iterable', 'iterativehealth', 'ixllearning', 'jamasoftware', 'jamf', 'janestreet', 'japan', 'jetbrains', 'jfrog', 'jumia', 'jumio', 'jumpcrypto', 'jumptrading', 'jumptrading', 'justanswer', 'justworks', 'juullabs', 'kaggle', 'kaleo', 'kalepa', 'kapitus', 'karat', 'karbon', 'kasisto', 'kentik', 'khanacademy', 'kiavi', 'kickstarter', 'kikoff', 'kite', 'klaviyo', 'klaxoon', 'knock', 'knowbe4', 'knowbe4', 'komodohealth', 'konovo', 'konradgroup', 'konradgroup', 'krafton', 'kungfuai', 'labcentral', 'labelbox', 'later', 'lattice', 'launchdarkly', 'layerzerolabs', 'lead', 'leaflink', 'learneo', 'learnupon', 'lendingtree', 'letsgetchecked', 'liberate', 'life360', 'liftoff', 'lightningai', 'lightricks', 'linkedin', 'liquidstack', 'lithic', 'liveperson', 'lob', 'logicgate', 'lokalise', 'loop', 'ltx', 'lucidmotors', 'lucidsoftware', 'luno', 'lyft', 'mabl', 'magic', 'magicleap', 'mantrahealth', 'mark43', 'marqeta', 'masterclass', 'mattermost', 'maymobility', 'mcmaster-carr', 'mco', 'mediaalpha', 'medium', 'mejuri', 'melio', 'mercari', 'mercury', 'messari', 'metropolis', 'mindbody', 'minio', 'mirakl', 'misfitsmarket', 'missionlane', 'mithril', 'mixmax', 'mixmode', 'mixpanel', 'mmhmm', 'modernanimal', 'mongodb', 'monzo', 'motional', 'motive', 'motivity', 'moxehealth', 'mozilla', 'myfitnesspal', 'myheritage', 'mythicalgames', 'n26', 'nanonets', 'nansen', 'nasuni', 'natera', 'nativeinstruments', 'nearspacelabs', 'neo4j', 'neocybernetica', 'nerdy', 'netdocuments', 'netherlands', 'netlify', 'neuralink', 'neuralink', 'newlabcareers', 'newrelic', 'newsela', 'newton', 'nexhealth', 'nexhealth', 'nextiva', 'nextroll', 'nintendo', 'nisc', 'nomadhealth', 'noredink', 'northspyre', 'novacredit', 'nubank', 'nurix', 'nuro', 'observeai', 'octus', 'oddball', 'odeko', 'offerup', 'ohme', 'okta', 'okx', 'olsson', 'olympusproperty', 'omadahealth', 'onbe', 'oneimaging', 'onemedical', 'onestudyteam', 'onetrust', 'onxmaps', 'openweb', 'openzeppelin', 'openzeppelin', 'oportun', 'optimal', 'optiverus', 'orchard', 'orderly', 'oscar', 'outschool', 'outsetmedical', 'outside', 'owllabs', 'ozow', 'pacaso', 'pagarme', 'pagaya', 'pagerduty', 'pandadoc', 'papa', 'parloa', 'partnerstack', 'partssource', 'pathai', 'patientpoint', 'paxlabs', 'payit', 'payit', 'payoneer', 'paypay', 'paypaycard', 'paypaysec', 'pdtpartners', 'pdtpartners', 'pebblepost', 'pelago', 'peloton', 'pendo', 'personalisinc', 'philo', 'phonepe', 'physicsx', 'picsart', 'pieinsurance', 'pinterest', 'pitchbookdata', 'planetscale', 'platformscience', 'platformsh', 'pleo', 'plume', 'point72', 'polyai', 'pontera', 'portable', 'portugal', 'poshmark', 'postman', 'postscript', 'praxis', 'primemedicine', 'primerai', 'prisma', 'project44', 'prolaio', 'proto', 'protonai', 'prove', 'psibufet', 'psiquantum', 'public', 'public-io', 'purestorage', 'pushpay', 'pushpay', 'qualtrics', 'quillbot', 'quince', 'quintoandar', 'quip', 'radar', 'rapp', 'razorpaysoftwareprivatelimited', 'reach', 'recharge', 'recordedfuture', 'recursionpharmaceuticals', 'redbadger', 'reddit', 'redventures', 'redwoodmaterials', 'reformation', 'relativity', 'relaypayments', 'relaypro', 'relaytherapeutics', 'remedy', 'remesh', 'remote', 'renttherunway', 'revivn', 'rhombuspower', 'rhymetec', 'ridgeline', 'rigup', 'riotgames', 'ripple', 'riskified', 'ritual', 'robinhood', 'roblox', 'rocketlab', 'roivantsciences', 'roku', 'roofr', 'roofstock', 'route', 'rti', 'rubrik', 'ruggable', 'rvohealth', 'sada', 'safariai', 'salesloft', 'salsify', 'sambanovasystems', 'samsara', 'samsungnext', 'samsungresearchamerica', 'sandscapitalmanagementllc', 'saucelabs', 'scaleai', 'scandit', 'science37', 'scopely', 'scotch', 'seatgeek', 'securityscorecard', 'seekout', 'seesaw', 'selffinancial', 'send', 'sendbird', 'sendcloud', 'sendle', 'sertis', 'sezzle', 'shakepay', 'shein', 'shift5', 'shopmonkey', 'showpad', 'sidecarhealth', 'sigmacomputing', 'sigmacomputing', 'similarweb', 'simplisafe', 'singlestore', 'singlestore', 'sisense', 'skillsoft', 'skyryse', 'skyscanner', 'slice', 'slickdeals', 'smartasset', 'smartasset', 'smartbear', 'smartling', 'smartlyio', 'smartrent', 'smartsheet', 'snorkelai', 'sofi', 'sojern', 'solarisbank', 'sourcegraph91', 'spaceship', 'spacex', 'spain', 'spin', 'splice', 'spothero', 'squad', 'squarepointcapital', 'squarespace', 'stabilityai', 'stackadapt-confidential', 'stackexchange', 'stackline', 'starcloud', 'startree', 'stitchfix', 'stockx', 'stokespacetechnologies', 'stone', 'storable', 'storyblocks', 'storyblok', 'stratolaunch', 'stripe', 'striveworks', 'stubhubinc', 'submittable', 'summitpartnerslp', 'sumologic', 'sumup', 'super', 'sweetgreen', 'swingeducation', 'symphony', 'synack', 'synthetaic', 'taboola', 'tailscale', 'taiwan', 'talkdesk2', 'tanium', 'taskrabbit', 'tatari', 'taxbit', 'tecovas', 'telnyx54', 'tempo', 'temporal', 'tenstorrent', 'tenstorrentuniversity', 'tenstreet', 'terakeet', 'tes', 'textio', 'textus', 'thedutchie', 'thehutgroup', 'theiconic', 'thenewyorktimes', 'thinkific', 'thirdlove', 'thirtymadison', 'thoughtworks', 'tifin', 'tines', 'tjt', 'toast', 'togetherai', 'tomorrow', 'toradex', 'torcrobotics', 'touchbistro', 'towerresearchcapital', 'traderepublic', 'traderepublicbank', 'transmitsecurity', 'tripactions', 'tripadvisor', 'triplelift', 'trivago', 'trove', 'truecaller', 'truelayer', 'truepill', 'trumid', 'trustpilot', 'truveta', 'tubitv', 'twilio', 'twitch', 'typeform', 'uberfreight', 'udacity', 'udemy', 'udio', 'unanet', 'unbounce', 'uniteus', 'unity3d', 'unqork', 'upbound', 'updater', 'upgrade', 'upstart', 'upstatement', 'upwork', 'urbansportsclub', 'vacasa', 'vardaspace', 'vaticlabs', 'vectara', 'vedantabiosciences', 'vercel', 'veriff', 'verkada', 'verve', 'vestmark', 'vestwell', 'via', 'vicarioussurgical', 'videoamp', 'virtru', 'visiersolutionsinc', 'vonage', 'voxmedia', 'vtex', 'vulcanelements', 'wallapop', 'waltzhealth', 'warp', 'waymark', 'waymo', 'webflow', 'weedmaps77', 'weee', 'wehrtyou', 'weinsteinproperties', 'weploy', 'wheely', 'wholesail', 'wholesail', 'wildlifestudios', 'wizeline', 'wizinc', 'wolt', 'wonderschool', 'workato', 'workstream', 'wunderkind', 'xai', 'xealth', 'xendit', 'yext', 'yipitdata', 'yld', 'yotpo', 'yubico', 'yugabyte', 'yugabyte', 'zenbusiness', 'zenoti', 'zenrows', 'zestai', 'zetaglobal', 'ziprecruiter', 'zocdoc', 'zola', 'zoominfo', 'zoro', 'zscaler', 'zuora', 'zwift'
];

// ─── Ashby company slugs ───
const ASHBY_SLUGS = [
  '0g', '10xteam', '1password', '1sphere', '3imembers', '42dot', '8fleet-inc', '9-mothers', '9fin', 'Cyberhaven', 'a-place-for-mom', 'a-team', 'abby-care', 'abe', 'abound', 'abridge', 'absentia-labs', 'academia', 'accurx', 'achira', 'acorns', 'acquisition', 'activesite', 'adaption', 'adaptive', 'adaptive-ml', 'adaptivesecurity', 'adaptyv', 'addi', 'additiveai', 'adonis', 'adtucon', 'afterquery', 'agent', 'agentio', 'agi-inc', 'aiand', 'aida', 'aidkit', 'airapps', 'airbound', 'airbyte', 'airgarage', 'airops', 'airspace-intelligence.com', 'airtasker', 'airwallex', 'aiwyn', 'akasa', 'alan', 'alcazar-energy', 'alchemy', 'alembic', 'aleph', 'alephalpha', 'alexai', 'alleviatehealth', 'allium', 'alljoined', 'allspice', 'almabase', 'almedia', 'alpenlabs', 'alternativepayments', 'altimate', 'altruistiq', 'ambiencehealthcare', 'ambient.ai', 'ambrook', 'amenitiz', 'ami', 'amo', 'amperos', 'amplitude', 'amplo', 'anagram', 'anatomy-financial', 'anglehealth', 'anima', 'anrok', 'ansiblehealth', 'answersnow', 'antares', 'anterior', 'antithesis', 'anyone-ai', 'anyscale', 'anysignal', 'anything', 'anyvan', 'apex-technology-inc', 'apexgrowth', 'applied', 'applied-behavioral-services', 'april', 'aqua-voice', 'aquarianlp', 'arago', 'arb-interactive', 'arbiter-ai', 'arbor', 'arcade', 'arcade-ai', 'arch.co', 'archive', 'arena', 'arkenstonedefense', 'arlo', 'array-behavioral-care', 'artemis', 'artisan', 'asari.ai', 'ascertain', 'ashby', 'ashgro', 'asimov', 'aspora', 'assembledhq', 'assorthealth', 'assured', 'assured-health', 'astera', 'astral', 'astro-mechanica', 'astronomer', 'asymmetric.re', 'ataraxis-ai', 'athena-hq', 'athenaactuarial', 'atlan', 'atlas', 'atlasresidential', 'atob', 'atomic', 'atomicindustries', 'atroposhealth', 'attention', 'atticus', 'attio', 'august-health', 'aurelian', 'aurorasolar', 'authzed', 'ava-labs', 'aven', 'avid4', 'avida', 'away', 'axelera', 'axiom', 'axiombio', 'axion', 'axle-health', 'baba', 'backflip', 'backflip.ai', 'backmarket', 'bankjoy', 'barkbus', 'barnes', 'barti', 'base', 'base-power', 'baseten', 'basiccapital', 'basis-ai', 'basis-research', 'bastion', 'baton', 'bayesianhealth', 'beacons', 'beam', 'beamery', 'beamimpact', 'bedrockocean', 'bem', 'ben', 'benchling', 'benevity', 'bespokelabs', 'bestow', 'better-mortgage', 'betterup', 'bevel', 'biconomy', 'binance.us', 'bioptimizers', 'birdie', 'blackbird-labs-inc', 'blacksmith', 'bland', 'blissway', 'block-labs', 'blockdaemon', 'blockhouse', 'blockstream', 'blockworks', 'blossom-health', 'blp-digital', 'blueberrypediatrics', 'blumen', 'bobyard', 'bookkeeper360', 'boost', 'botcrew', 'bounce', 'brainco', 'brainly', 'braintrust', 'branchlab', 'bravehealth', 'bree', 'brellium', 'brightstar-ai', 'brightwheel', 'brigit', 'brinc', 'brisk-teaching', 'bubble', 'buffer', 'build', 'buildout', 'bullpen-talent', 'bunch', 'bunkerhillhealth', 'bureau', 'burklandassociates', 'buspatrol', 'camber', 'cambio', 'cambly', 'campfire', 'campus', 'camunda', 'canals', 'candidhealth', 'cantina', 'canvas-medical', 'cape', 'carbonx', 'cardless', 'careers.azx.io', 'cargado', 'cargo-one', 'cartesia', 'cas', 'casap', 'casca', 'catalant-technologies', 'causal', 'causaly', 'cbai', 'cchn', 'centerfield', 'centivo', 'chainalysis-careers', 'chalkboard', 'chambercardio', 'chapter', 'character', 'charthop', 'chatbase', 'checkly', 'chestnut', 'chromatic', 'chronospherejobs', 'circuithub', 'citizen', 'civilgrid', 'claim-health', 'claimsorted', 'clair', 'claritypay', 'claritypediatrics', 'clarium', 'clasp-group', 'classdojo', 'claylabs', 'clearco', 'clearvector', 'clerk', 'clickhouse', 'clickup', 'clipboard', 'clipbook', 'close', 'cloudzero', 'clubhouse', 'cluely', 'coactive', 'coalesce', 'cobot', 'coder', 'coderabbit', 'codes-health', 'codeway', 'coefficientgiving', 'cognition', 'cohere', 'coinflow', 'coinhako', 'cointracker', 'colonist', 'column', 'comfy-org', 'comity', 'commonroom', 'commons', 'commure', 'compa', 'company', 'composio', 'compound', 'concourse', 'conduct', 'conduit', 'confiant', 'confluent', 'conscious-talent', 'contentoo', 'continue', 'contra', 'convey', 'coreflow', 'coreoftheheart', 'cortea', 'cosmos', 'cosuno', 'counsel', 'coursecareers', 'cow-dao', 'cradlebio', 'creatify', 'creatoriq', 'critical-energy', 'crosby', 'crusoe', 'cruxclimate', 'cryptio', 'cubby-beds', 'cube', 'cubesoftware', 'cubic3', 'curri', 'cursor', 'cuspai', 'cybcube', 'cyber.fund', 'cyberhaven', 'cylinderhealth', 'cytora.com', 'cyvl', 'd-matrix', 'dailypay', 'dakota', 'dandy', 'darkroom', 'dash0', 'datacurve', 'datafold', 'dataguard', 'dataplor', 'datasnipper', 'datasnipper.com', 'datologyai', 'dave', 'david-ai', 'davidenergy', 'davistechnologymanagement', 'day9', 'daydream-ai', 'decagon', 'decart-ai', 'decimal', 'deel', 'deepgram', 'deepl', 'deepnote', 'deepsky', 'deepslate', 'deeptune', 'definelycareers', 'dehazelabs', 'delinea', 'deliveroo', 'delphi', 'delve', 'demandbase', 'depthfirst', 'develop-health', 'devsavant', 'dexmate', 'diagrid', 'directive', 'dispatch', 'distributed-spectrum', 'ditto', 'diversified-botanics', 'docker', 'doppler', 'doss', 'dottxt', 'double', 'doxy.me', 'drata', 'dreamthree', 'dualentry', 'dubclub', 'duck-duck-go', 'duckbill', 'duet', 'duna', 'dune', 'dust', 'dyna-robotics', 'e2b', 'earthforce', 'easygenerator', 'easyllama.com', 'echo', 'ecosia.org', 'edia', 'edra', 'edsights', 'edvisorly', 'effective-ai', 'egra', 'eigen-labs', 'eightsleep', 'ekho', 'ekumenlabs', 'electric', 'element451', 'elevenlabs', 'eliseai', 'eliza', 'elliptic', 'ello', 'eloquentai', 'ema', 'embedding-vc', 'emerald-ai', 'emora-health', 'empirical-security', 'empora', 'endex', 'endgame', 'endurance-energy', 'ens-labs', 'epidemic-sound', 'equal-ventures', 'equip', 'ernest', 'espa', 'espresso', 'essentialai', 'etched', 'ether.fi', 'ethereum-foundation', 'ethglobal', 'euclid-power', 'eventual', 'everai', 'everfield', 'everops', 'everself', 'everstar', 'evertune', 'every-io', 'exa', 'exegy', 'expressable', 'extend', 'eyebot', 'ezhealth', 'eztexting', 'factory', 'faculty', 'far.ai', 'farmraise', 'farsight', 'fathom.video', 'featherlessai', 'feathr', 'fernstone', 'fieldguide', 'figure', 'filmhub', 'fin', 'finch', 'finni-health', 'firecrawl', 'firstmate', 'firstround', 'firststreet', 'fitt', 'fizz', 'flagright.com', 'flagstone', 'flai', 'flashbots.net', 'fleetline', 'fleetpulse', 'fleetworks', 'flint', 'flipturn', 'floatme', 'flora', 'flowengineering', 'flowhub', 'fluency', 'flux', 'focused', 'fonoa', 'forerunner', 'formance', 'forum-ventures', 'found', 'foundry-for-good', 'fourier', 'fourth-power', 'fractional-ai', 'freed', 'frequence', 'freshpaint', 'frontcareers', 'fuel-cycle', 'fulcrum', 'fullstory', 'fundamentalresearchlabs', 'fundwell', 'further', 'furtherai', 'fuse', 'futurefitai', 'futureproofing', 'g2', 'g2i', 'gamechanger', 'gamma', 'garage', 'general-medicine', 'generalintelligencecompany', 'generalist', 'genies', 'genomics', 'geoforce', 'gigaml', 'gitbook', 'givebutter', 'glacis-ai', 'glide', 'glimpse', 'global-x-etfs', 'glomo', 'glossgenius', 'glow25', 'go-nimbly', 'goanagram', 'going', 'goldsky', 'golinks', 'goodship', 'goodstack', 'goody', 'gorgias', 'gotphoto', 'govdash', 'goveagle', 'govsignals', 'govwell', 'gptzero', 'granica', 'granola', 'granted', 'graphite', 'graphitehq', 'gravityclimate', 'graymatter-robotics', 'greatquestion', 'green-tree-school-and-services', 'greenlitecareers', 'gridcare', 'gridunity', 'gruntwork', 'grvt', 'gt-bio', 'haast', 'hackerone', 'hadrian-automation', 'halliday', 'halter', 'handshake', 'handspring', 'hang', 'hanover-park', 'happyrobot.ai', 'harmonic', 'harvey', 'hatch', 'haus', 'hawk', 'hawkeyeinnovations', 'haydenai', 'haystacknews', 'hcompany', 'healthaxis', 'healthprogresshub', 'healthsherpa', 'hebbia-ai', 'hedra', 'heidihealth.com.au', 'heirloomcarbon', 'helion', 'helius', 'hellobrightline', 'hellohera', 'hellopatient', 'helm-ai', 'helpscout', 'heron-power', 'heyjobs', 'higharc', 'highbeam', 'highlightai', 'hightouch', 'hiive', 'hims-and-hers', 'hirehangar', 'hive.co', 'hivehealth', 'hivesmart-consulting', 'hiya', 'hockeystack', 'homebase', 'homebot', 'homebound', 'homevision', 'honeybook', 'honeydew', 'hopper', 'horizon3ai', 'hotspexmedia', 'hoxtonfarms', 'hubstaff', 'hud', 'hudu', 'humaans', 'human', 'human-computer-lab', 'humans-and', 'humatahealth', 'hyperbolic', 'hypercubic', 'hyperexponential', 'hyperhug', 'ibotta', 'ideals', 'ideogram', 'idler', 'illumio', 'immersivelabs', 'imprint', 'improbable', 'impulse', 'inato', 'inertia', 'inference', 'infinite', 'infinity-constellation', 'infisical', 'influxdata', 'injective', 'innate', 'inngest', 'insitro', 'inspectiv', 'inspiren', 'instructure', 'intellistack', 'interaction', 'interface', 'interplay', 'interrahealth', 'intro', 'intus', 'ironcladhq', 'iverify', 'jampack-ai', 'january', 'jbs-dev', 'jellyfish', 'jellyfishcareers', 'jerry.ai', 'jigsaw', 'jimdo.com', 'join9am', 'joinbetter', 'joinsherpa', 'joor', 'joyfulhealth', 'judgmentlabs', 'juicebox', 'julius', 'jump', 'jump-app', 'junction', 'junior', 'junipersquare', 'justplay-gmbh', 'k-id', 'kale', 'kalibri-labs', 'kalshi', 'kamiwaza', 'kayak', 'keep', 'kepler-ai', 'kernel', 'keyrock', 'kilocode', 'kin', 'kindred', 'kirin', 'kit', 'kiwi', 'known', 'knox-systems', 'kodex', 'kognitos', 'kognity', 'kojo', 'kombo', 'kong', 'kraken.com', 'krea', 'kueski', 'kustomer', 'ladder', 'lambda', 'lancedb', 'langchain', 'lap', 'lark', 'latamcent', 'latchbio', 'latitudecareers', 'laurel', 'lawhive', 'layerfi', 'leadbank', 'leandata', 'leantechniques', 'leap', 'leapsome', 'ledger', 'legionhealth', 'leland', 'lemlist', 'lemonade', 'lendable', 'leona', 'level', 'levelpath', 'lgads', 'li.fi', 'libra', 'lido.fi', 'life-space-digital', 'lightdash', 'lightning', 'lightspark', 'lilt-corporate', 'limble', 'linda', 'lindy', 'linear', 'linera.io', 'linqapp', 'liquid-ai', 'listenlabs', 'lithosquare', 'liv-golf', 'livekit', 'livinghr', 'lm-studio', 'loancrate', 'logiqal', 'loom', 'loopio', 'loora', 'loot-labs', 'lottie', 'loula', 'lovable', 'loveholidays', 'lpadesignstudios', 'luminai', 'luminary', 'luminovo', 'lunar', 'lydian', 'lynk', 'lyric', 'm-kopa', 'm13', 'mach', 'mach9', 'macroscopic', 'madhive', 'magic.dev', 'magical', 'magiceden', 'magicschool', 'maincode', 'mainstay', 'maintainx', 'mandolin', 'mangomint', 'manifest-law', 'manusai', 'mapbox', 'maple', 'marble', 'marianaminerals', 'mariner-careers', 'marloo', 'marshmallow', 'masabi', 'materialize', 'maticrobots', 'matter-intelligence', 'matter-labs', 'maximustribe', 'maybern', 'mazedesign', 'mazehq', 'mebe', 'mechanize', 'medely', 'medraai', 'medscout', 'meetmarvin', 'megazone', 'menlosecurity', 'mercor', 'merge', 'meridianlink', 'meshy', 'metaforms', 'metaview', 'meter', 'method', 'mexdigital', 'midstream', 'mindbeam', 'mindly', 'mindvalley', 'mintlify', 'mirage', 'miri', 'miro', 'miter', 'mobasi', 'mobbin.com', 'modal', 'modernfi', 'moderntreasury', 'modus', 'moego', 'molecule-software', 'monaco', 'monarchmoney', 'monsters', 'montecarlodata', 'moonlake', 'moonshot-ai', 'moonvalley-ai', 'moraleshr', 'morpho', 'mosaic', 'mosey', 'motherduck', 'motorway', 'moxfive', 'moxie', 'mubi', 'mudflap', 'multiply', 'multiverse', 'mural', 'mux', 'mystenlabs', 'mytomorrows', 'n1', 'n8n', 'nabihealth', 'nango', 'nanonets', 'nash', 'nationgraph', 'navi', 'nectar-social', 'nelo', 'neon', 'nerdwallet', 'nest-health', 'nestmed', 'nestveterinary', 'netboxlabs', 'netgear', 'nethermind', 'netic', 'netwealth', 'neuroscale', 'nevoya', 'new-story', 'newform', 'newfront', 'newlantern', 'nextpatient', 'nexus-cognitive', 'nexus.xyz', 'nexxa', 'nidus-technologies', 'nightfall-ai', 'nimbl', 'nivoda', 'noda-ai', 'noise-labs', 'nomad', 'nomos', 'nord-security', 'norm-ai', 'northslope-technologies', 'northwoodspace', 'nory', 'notable', 'notion', 'novita-ai', 'novo', 'nucleus', 'nudge', 'numeral', 'numeric', 'nuna', 'nursa', 'oakland-feather-river-camp', 'oaknorth', 'observable-space', 'obviant', 'obvio', 'obvious', 'ocra', 'odys-aviation', 'odyssey', 'office-hours', 'olympus', 'omaze', 'omnea', 'omni', 'omniscient', 'one-pass-solutions', 'oneapp', 'onebrief', 'onecrew', 'oneleet', 'onepot', 'onereach.ai', 'oneschema', 'onhires', 'onramp', 'opal', 'openai', 'openevidence', 'opengov', 'openhands', 'openhomefoundation', 'openly', 'openrouter', 'opensea', 'opfoundation', 'oplabs', 'opslevel', 'optimum', 'optro', 'opus1', 'opusclip', 'orb', 'orbit', 'orbital', 'orca', 'orchard', 'orum', 'osmo', 'oso', 'oumi', 'outpost', 'outpostnow', 'outset', 'outsmart', 'outtake', 'overflow', 'overviewenergy', 'owner', 'oxio', 'oxman', 'oyster', 'p2p.org', 'paddle', 'palette-media', 'palmstreet', 'pano-ai', 'panoptyc', 'parabola-io', 'paradigm', 'paradox', 'parafin', 'paraform', 'paragon', 'parallel', 'parashift', 'pareto-ai', 'parity', 'parker', 'partiful', 'partsbase', 'passage', 'passport', 'patch.io', 'patreon', 'paxos', 'payabli', 'pebl', 'peek', 'people-culture-talent', 'peppr', 'perchwell', 'perk', 'permitflow', 'perplexity', 'persona', 'persona.ai', 'phantom', 'phia', 'phil', 'phoebe', 'phoebe-work', 'phoenix', 'phonic', 'physicalintelligence', 'picogrid', 'pika', 'pinecone', 'plaid', 'plain', 'planehr', 'plantingspace', 'plasma', 'plasmidsaurus', 'plaud', 'playground', 'playson', 'pleo', 'pluralfinance', 'pmmalliance', 'pod-network', 'podium-automation', 'poesis', 'polaranalytics', 'polymarket', 'poolside', 'popl', 'posh', 'posh-ai', 'poshmark', 'posthog', 'powerus', 'pravah', 'prefect', 'preference-model', 'prelim', 'primary', 'primeintellect', 'primer', 'primer.io', 'prior-labs', 'procurementsciences', 'procurify', 'prodigy-education', 'product-now', 'profound', 'project-expedition', 'prokeep', 'prometheus', 'promise', 'promise-studios', 'prompt', 'propelus', 'protege', 'provable', 'proxima-fusion', 'puzzle.io', 'pylon', 'pylon-labs', 'pythnetwork', 'quadrivia', 'qualified', 'quant-aq', 'quantware', 'quarks-tech', 'quartermaster', 'quicknode', 'qumis', 'quora', 'quotewell', 'rabot', 'radai', 'radar', 'radiant', 'raiku', 'railway', 'rain', 'ramp', 'range', 'rapdev', 'raptive', 'raspberry', 'raycast', 'reacher', 'read-ai', 'ready', 'real', 'rebecca-school', 'recraft', 'red-gate', 'redis', 'redpine', 'reducto', 'reedsy', 'reevo', 'reflect-orbital', 'reflectionai', 'reflexrobotics', 'reflow', 'reframesystems', 'regent', 'rehire', 'reindeer-ai', 'reinforce-labs-inc', 'reka', 'reklamehealth', 'relay', 'relayfi', 'relayprotocol', 'remarcable-inc', 'remedyrobotics', 'render', 'renuity', 'replit', 'replo', 'reprally', 'reprise', 'rerun', 'rescale', 'resend', 'resq', 'restream', 'retell-ai', 'rev', 'reve', 'revenuecat', 'revic', 'reviserobotics', 'revv-hq', 'rewind', 'rho', 'ridealso', 'rilla', 'rillet', 'river', 'riveron', 'roadsurfer.com', 'roboflow', 'rogo', 'roo-code', 'roompricegenie', 'rothys', 'rowan', 'rubie', 'ruby-labs', 'rula', 'rundoo', 'runna', 'runpod', 'runway', 'rwazi', 'rythm', 's2', 'safelease', 'sagelabs.ai', 'sahara', 'salesape-ai', 'salient', 'sanctuary', 'sandbar', 'sandboxaq', 'sanity', 'sapiom', 'sardine', 'sarvam', 'satispay', 'savvy', 'scalemath', 'scaler', 'scan-com', 'scarlet', 'sciforium', 'scorewarrior', 'scribdinc', 'scribe', 'sdsc', 'seamflow', 'seconddinner', 'sellfire', 'semgrep', 'seneca', 'sensmore', 'sent', 'sentient', 'sentra', 'sentry', 'seon', 'sequence', 'serverobotics', 'sesame', 'sevaro', 'sevenai', 'sfcompute', 'shepherd', 'shiftkey', 'shortstory', 'sibill', 'siena', 'sierra', 'sierra-studio', 'sieve', 'siftstack', 'signalwire', 'signoz', 'sigp', 'silver', 'sim', 'simular', 'siro', 'sisu', 'sitemate', 'siteminder', 'skimmer', 'skip-loans', 'skydio', 'skymavis', 'skynrg', 'slant', 'slash-financial', 'sleeper', 'slingshot-aerospace', 'slingshotai', 'slope', 'smallest', 'smalls', 'smallstep', 'smartleaf', 'snappy', 'snd', 'snowball', 'snowflake', 'snyk', 'sobek-ai', 'socure', 'softwarevision', 'sola', 'solace', 'solanalabs', 'solstice', 'somethings', 'somnia', 'sondermind', 'sonio', 'sorare', 'sourgum', 'span', 'span.app', 'spare', 'speak', 'speakeasy', 'spear-ai', 'spearbio', 'specter', 'spexi', 'spherical', 'spiral', 'splose', 'spotdraft', 'sprinter-health', 'squad', 'squads', 'squint.ai', 'ssi', 'st-labs', 'stable', 'stacker', 'stackone', 'stainlessapi', 'standardfleet', 'starbridge', 'starpath.space', 'startvim', 'stash', 'statista', 'statsig', 'stay22', 'stayai', 'staycation', 'steel', 'stellar', 'stellar-health', 'stepful', 'stickermule', 'strategic-growth-partners', 'strava', 'stream', 'streetgroup', 'strongdm', 'stronghold', 'stuut-ai', 'stytch', 'substack', 'subzero', 'succinct', 'suite-studios', 'sunday', 'sunflower-sober', 'suno', 'supabase', 'super.com', 'superdial', 'superhuman', 'superlinear', 'superpower', 'suzy', 'swans', 'swarmer', 'swarmia', 'sweatpals', 'sweedpos.com', 'sweep', 'swoop', 'sydecar', 'symbiotic', 'symmetry', 'synquery', 'synthesia', 'synthflow', 'synthpop', 'tabs', 'tabz', 'taekus', 'tajir', 'take2', 'taktile', 'talentsafari', 'talkiatry', 'talos-trading', 'tapcart', 'tarro', 'tavahealth', 'tavily', 'tavus', 'taxfix.com', 'teal-health', 'teambridge', 'teamworks', 'technimove', 'tekion', 'teleskope', 'tem', 'tempo', 'tempo-xyz', 'tenderly', 'tenexlabs', 'tennr', 'tensorwave', 'teraswitch', 'terraai', 'terranova', 'tessera-labs', 'texture', 'teya', 'the-exploration-company', 'the-flex', 'the-global-talent-co', 'the-learning-spectrum', 'the-studio', 'theflex', 'themindcompany', 'thesis', 'thewfsgroup', 'theydo', 'thndr', 'thought-machine', 'thrill-labs', 'tigerdata', 'tilthq', 'timely', 'tin-can', 'titan', 'titan-ai', 'tldr.tech', 'toma', 'toms', 'toogeza', 'top-hat', 'topline-pro', 'toposbio', 'traba', 'trainline', 'transfr', 'transgrid-energy', 'traversal', 'trawa', 'treeswift', 'tremendous', 'triumph-arcade', 'trm-labs', 'truelogic', 'trust-wallet', 'truthsystems', 'tryalma', 'tunnl', 'turnkey', 'turnstile', 'turquoise-health', 'twelve', 'twelve-labs', 'twenty', 'twin-so', 'tyba', 'udisc', 'uipath', 'unify', 'union', 'union-tech', 'uniswap', 'unit', 'unit410', 'unitxlabs', 'universalagi', 'unlearn', 'unstructured', 'unwrap', 'uplane', 'upside', 'upside-tech', 'uptimeai', 'upvest', 'usekernel', 'usul', 'vanilla', 'vanta', 'vantageanalytics', 'vapi', 'vector', 'vegaclaims', 'vellum', 'vendelux', 'vercel', 'versemedical', 'vertical-aerospace', 'verto', 'vetcove', 'vibe', 'vibecode', 'vibiz', 'viessmann', 'vinci4d', 'virtahealth', 'virtuous', 'visier', 'vitalize', 'vitvio', 'viz.ai', 'voldex', 'voleon', 'vori', 'vow', 'voxel', 'vyn', 'vynca', 'wagmo', 'walrus', 'warp', 'watershed', 'wayflyer', 'wealth-com', 'wealthsimple', 'weave', 'weaviate', 'webai', 'weekend', 'wellth', 'what3words', 'wheel', 'whetstoneresearch', 'whippy', 'winona', 'wisp', 'wispr-flow', 'wistia', 'withclutch', 'withdaydream', 'withdefault', 'withpulley', 'withwisdom', 'witnessai', 'woflow', 'wordsmith', 'workweave', 'workyard', 'worldly', 'wormholelabs', 'wrapbook', 'writer', 'wundergraph', 'xbowcareers', 'yeet', 'yendo', 'yondr', 'you-health', 'yourco', 'zapier', 'zayzoon', 'zed', 'zeely', 'zeit-ai', 'zello', 'zencastr', 'zenjob', 'zero', 'zerorfi', 'zettabyte-space', 'zilch', 'zip', 'zippymh', 'zyphra'
];
...
// ─── Lever company slugs ───
const LEVER_SLUGS = [
  '15five', '1inch', '3pillarglobal', 'accesssoftek', 'accurate', 'acds', 'achievers', 'activecampaign', 'addx', 'aeratechnology', 'aero', 'agiloft', 'air-tek', 'airalo', 'aircall', 'airtasker', 'aleph', 'allegiantair', 'alltrails', 'ambergroup', 'analogfolk', 'analyticpartners', 'anchorage', 'angellist', 'animocabrands', 'anomali', 'apolloagriculture', 'appen', 'appen-2', 'applydigital', 'appzen', 'apryse', 'arcadia', 'arrivelogistics', 'artera', 'articulate', 'assist-world', 'ataccama', 'atlassian', 'basis', 'bazaarvoice', 'benchsci', 'better', 'binance', 'blablacar', 'bloom', 'bluebottlecoffee', 'bluecatnetworks', 'bluelightconsulting', 'bounteous', 'brevo', 'brighte', 'brightmachines', 'brightwheel', 'brilliant', 'brillio-2', 'bumbleinc', 'businesswire', 'butcherbox', 'cagents', 'candidate', 'capital', 'captivateiq', 'carbonhealth', 'celestia', 'cellares', 'centrifuge', 'cents', 'certifyos', 'chownow', 'ciandt', 'cic', 'cin7', 'citcon', 'civitech', 'clari', 'clarifyhealth', 'cleanspark', 'clearcapital', 'cloudinary', 'coalfire', 'coderpad', 'coingecko', 'coinmarketcap', 'coins', 'collabora', 'color', 'comply', 'connectly', 'contentsquare', 'cred', 'crowdriff', 'crypto', 'd2l', 'datalabusa', 'deleteme', 'deliverect', 'demo', 'deputy', 'digimarc', 'digitalmediamanagement', 'disher', 'dlocal', 'docsumo', 'doola', 'dreamgames', 'drivemode', 'drivetrain', 'dronedeploy', 'educative', 'elfbeauty', 'emitwise', 'emma-sleep', 'employ', 'empowerly', 'enable', 'enki', 'equativ', 'erg', 'esper', 'eternal', 'everbridge', 'everlywell', 'ezcater', 'factor', 'fampay', 'farfetch', 'fatetherapeutics', 'fevo', 'fi', 'field-ai', 'filevine', 'finch', 'find', 'finn', 'fiscalnote', 'floqast', 'freedompay', 'freeletics', 'fresha', 'freshworks', 'gearset', 'genesis', 'getlabs', 'getwingapp', 'gopuff', 'greenlight', 'gridline', 'gynger', 'h1', 'happyco', 'happyhiller', 'harmony', 'hcvt', 'healthcare', 'heartbeathealth', 'hermeus', 'hevo', 'hhaexchange', 'highspot', 'hightechhigh', 'hive', 'illumination', 'influur', 'ion', 'ivo', 'jamcity', 'jetbrains', 'jobandtalent', 'jumpcloud', 'justwatch', 'kabam', 'kavak', 'kepler', 'kiddom', 'kinsta', 'klivvr', 'kogan', 'kpler', 'kraken', 'kraken123', 'kubra', 'labelbox', 'ladders', 'lalamove', 'lamudi', 'latch', 'lemon', 'lendbuzz', 'levelai', 'levelup', 'lever', 'leverdemo-8', 'linkedin', 'loadsmart', 'logz', 'lucidworks', 'lumivero', 'lumotive', 'luxurypresence', 'lyrahealth', 'mactores', 'mahmee', 'masterycharter', 'matchgroup', 'matillion', 'medium', 'meesho', 'megaport', 'mendix', 'merklescience', 'metabase', 'metaprise.ai', 'metlife', 'metopera', 'metr', 'mindbloom', 'mindtickle', 'minted', 'mistral', 'moonpay', 'morningbrew', 'morningconsult', 'musixmatch', 'nava', 'neighbor', 'neon', 'netflix', 'netomi', 'newton', 'nielsen', 'nimblerx', 'ninjavan', 'nium', 'nominal', 'novatalent', 'numeris', 'offchainlabs', 'omnisend', 'openx', 'outreach', 'owner', 'palantir', 'palo-it', 'parallelwireless', 'patsnap', 'pattern', 'payjoy', 'paytm', 'pditechnologies', 'peakgames', 'peerspace', 'penumbrainc', 'people-ai', 'peoplegrove', 'perforce', 'petvisor', 'picklerobot', 'pipedrive', 'pivotal', 'placemakr', 'plaid', 'planettechnologies', 'planner5d', 'plexus', 'plusgrade', 'pointclickcare', 'poki', 'polleverywhere', 'pp-la', 'ppfa', 'ppgny', 'prismic', 'proof', 'proper', 'prosper', 'protective', 'protolabs', 'provi', 'qonto', 'quantcast', 'quantummetric', 'questanalytics', 'quokka', 'rackspace', 'rainfocus', 'realself', 'redsox', 'regrello', 'relay', 'researchgate', 'restaurant365', 'revel', 'revhealth', 'rhombus-systems', 'rise', 'rivr', 'ro', 'robust-ai', 'rover', 'safe', 'sanabenefits', 'sanctuary', 'sandboxvr', 'saviynt', 'sensortower', 'shieldai', 'shopback-2', 'signal', 'simplybusiness', 'singerlewak', 'skyslope', 'smarsh', 'smart-working-solutions', 'snaplogic', 'snowplow', 'sonatype', 'sophos', 'spotify', 'spreedly', 'spreetail', 'sprucesystems', 'spyke-games', 'stackblitz', 'standtogether', 'startengine', 'stax', 'suger', 'super', 'supermove', 'superpedestrian', 'superside', 'sure', 'surglogs', 'swordhealth', 'symplicity', 'synthego', 'sysdig', 'system1', 'tackle', 'tala', 'talkwalker', 'tapasmedia', 'tealbook', 'teamsnap', 'tecton', 'teikametrics', 'tekton', 'teleport', 'telesat', 'terminus', 'textnow', 'theathletic', 'theblockcrypto', 'thimble', 'thinkahead', 'thinkingbox', 'tildei', 'toku', 'tonkean', 'topanga', 'torchdental', 'trendyol', 'trueml', 'trunkio', 'trustly', 'ttecdigital', 'txidigital', 'uberflip', 'unico', 'upguard', 'vacancies', 'vedatechlabs', 'veeva', 'vendavo', 'venteur', 'veo', 'vergesense', 'versapay', 'vevo', 'vida', 'vivrelle', 'voodoo', 'vrchat', 'walkme', 'waveapps', 'wealthfront', 'wealthsimple', 'whereby', 'whoop', 'willowinc', 'wisdomai', 'wonolo', 'workramp', 'workwave', 'wr', 'yardzen', 'z1tech', 'zencore', 'zensurance', 'zeta', 'zinier', 'zocks', 'zoox'
];
...
const PERSONIO_SLUGS = [
  'acme', 'activation', 'ada', 'again', 'agile-robots-se', 'ahead', 'alan', 'alchemy', 'angela', 'arctic', 'arne', 'arweave', 'atlas', 'aurora', 'aware', 'axio', 'banxware', 'basis', 'bedrop', 'benjamin', 'betty', 'bolt', 'builders', 'bunch', 'cabify', 'carbon', 'carl', 'cas', 'celonis', 'charlotte', 'cic', 'cinnamood-gmbh', 'clark', 'climate', 'closed', 'code', 'codex', 'contabo', 'cosmos', 'cosuno', 'deepslate', 'demo', 'digitalservice', 'ecp', 'egym', 'emma-sleep', 'finn', 'forward', 'framer', 'freeletics', 'gnosis', 'govtech', 'gsa', 'ipo', 'jtexpress', 'julius', 'kaiko', 'kit', 'kiwi', 'lalamove', 'leap', 'merantix', 'monday', 'neon', 'opal', 'ottonova', 'patrick', 'penta', 'personio', 'phoenix', 'planradar-gmbh', 'powerus', 'quantpi', 'quantware', 'raiku', 'researchgate', 'scroll', 'sim', 'skynrg', 'smava', 'solarisbank', 'sunday', 'tado', 'tandem', 'teleport', 'tonies', 'tractable', 'traderepublic', 'trawa', 'twelve', 'upstart', 'urbansportsclub', 'usercentrics-gmbh', 'vivid', 'wandelbots', 'wunderflats'
];
...
const SMARTRECRUITERS_SLUGS = [
  '22ndcenturytechnologiesinc', 'Canva', 'DeliveryHero', 'Freshworks', 'Polygontechnology', 'ServiceNow', 'Wise', 'adeebaeservicespvtltd', 'allabouttruckingsolutions', 'anteelo', 'aristanetworks', 'asifr', 'aviko', 'betsol', 'blueoptima', 'brimore', 'captechconsulting', 'carespot', 'cars24', 'cdnetworks', 'cern', 'citech', 'coditationsystems', 'comoto', 'cricut', 'currytekmanagementgroup', 'cyclotech', 'dashlabsai', 'dataiku', 'ejobs', 'elitebrain', 'financeapp', 'firstserviceresidential', 'forloopai', 'glean', 'gousto', 'groupecanam', 'guidehealth', 'hawthorne', 'healthpartners', 'hibob', 'hrdpt', 'hsmc1', 'ibotta', 'iceland', 'iflip4', 'ifs1', 'indonesia', 'indsoftinc', 'inentinc1', 'insegment', 'iqarus', 'iqeq', 'jpixx', 'jysk', 'kaeferintegratedservicesptyltd', 'kimberlyclark', 'klaxoon', 'krgtechnologyinc', 'lancesoftinc2', 'lely1', 'libertyresourcing', 'lingohub', 'loblawdigital', 'm1finance', 'manpowerfrance', 'mazars', 'mcg1', 'morguard', 'nexity', 'nexthink', 'nobroker', 'nocd', 'north40outfitters', 'omio1', 'omya', 'optionsgroup2', 'palermorhodes1', 'pentavalue', 'ph7', 'polygontechnology', 'powellsupportiveservices', 'prosum2', 'ra2', 'rebelfoods', 'resume-library', 'reversinglabs', 'rodeofx', 'shaws', 'shipsy', 'signode', 'smartrecruiters', 'snv', 'sportradar', 'structube1', 'swiggy', 'swissquote', 'syntegon', 'tekwissen4', 'thewhitelabelfirm', 'tipico', 'tpistaffinginc', 'trginc', 'uff1', 'uncommonschools', 'unit44', 'upstox', 'usm2', 'valleysurgemarketinginc', 'vams', 'vaticlabs', 'vipkid', 'w3r1', 'wayfair', 'wildbrain', 'xiaomi', 'xperttech1', 'zoro'
];

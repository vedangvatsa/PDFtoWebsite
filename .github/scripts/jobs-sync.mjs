...
const GREENHOUSE_SLUGS = [
  ...
  'canva','carta','cerebral','cerebrassystems','characterai','checkout','chime','circleci','clearbit','clevertap',
  'cloudflare','cloverhealth','coactive','cockroachlabs','cognism','cohere','coinbase','compass','confluent','consensys',
  'contentful','contextualai','copyai','coreweave','couchbase','coursera','cresta','cribl','customerio','cybersource',
  'dagger','dapperlabs','databricks','datadog','datastax','dbtlabs','deepmind','descript','dialpad','discord',
  'dlocal','doordashusa','dropbox','duolingo','elastic','epicgames','epsilon','equifax','experian','faire',
  'fastly','fico','figma','figureai','fireblocks','fireworksai','fis','fiserv','five9','fivetran',
  'fleetio','flexport','formhealth','gemini','genesys','ghost','gitlab','globalpayments','glossier','gong',
  'google','govtech','grafanalabs','graphcore','greenhouse','gusto','hashicorp','heap','helio','heygen',
  'hubspot','huggingface','idme','iherb','inflection','inflectionai','infobip','instacart','intercom','iterable',
  'jasper','jetbrains','jfrog','justworks','khanacademy','klaviyo','kochava','labelbox','later','lattice',
  'launchdarkly','layerzerolabs','leanplum','lightningai','liveramp','looker','lucidmotors','lusha','lyft','magic',
  'mailchimp','marqeta','masterclass','medium','melio','mercari','mercury','messagebird','meta','midjourney',
  'miro','mixpanel','mmhmm','moengage','mollie','mongodb','monzo','moralis','motional','moveworks',
  'mozilla','mparticle','mutiny','n26','neo4j','netlify','notion','nubank','nuro','observeai',
  'okta','okx','onemedical','onesignal','opendoor','opensea','oscar','outreach','pagerduty','pathai',
  'patreon','payoneer','paypal','paytm','payu','peloton','pendo','phantom','phonepe','pinterest',
  'planetscale','plivo','postman','postscript','rapyd','razorpay','reddit','redfin','redis','relativity',
  'remote','ringcentral','riotgames','ripple','rippling','robinhood','roblox','rudderstack','runwayml','salesloft',
  'sambanovasystems','samsara','scaleai','scopely','segment','sendbird','sendgrid','sinch','singular','skillshare',
  'slack','snap','snorkelai','snowplow','sofi','spacex','square','stabilityai','stockx','stripe',
  'synthesia','tailscale','talkdesk','tealium','teams','temporal','tenstorrent','thedutchie','toast','togetherai',
  'traderepublic','transunion','treasuredata','trivago','tsys','twilio','twitch','typeform','uber','udemy',
  'udio','unity3d','upgrade','urbanairship','vantiv','vectara','vercel','verkada','vimeo','vonage',
  'warp','waymo','webex','webflow','worldpay','writesonic','wunderkind','xai','xendit','zapper',
  'zerion','zillow','ziprecruiter','zoom','zoominfo','zscaler'
];
...
const LEVER_SLUGS = [
  ...
  'bluecatnetworks','bluelightconsulting','bored-ape-yacht-club','bounteous','brevo','brilliant','brillio-2','bumbleinc','businesswire','butcherbox',
  'bybit','cagents','capital','captivateiq','celestia','cellares','celo','celsius','centrifuge','cents',
  'certifyos','chia','chownow','ciandt','cic','circle','civitech','clari','cleanspark','clear',
  'cloudinary','coalfire','coinbase','coingecko','coins','color','comply','compound','connectly','contentsquare',
  'convexfinance','cosmos','creamfinance','cred','crypto','cryptokitties','cryptopunks','curve','dYdX','dai',
  'datalabusa','decentraland','deleteme','deliverect','demo','deputy','deribit','digimarc','digitalmediamanagement','disher',
  'dlocal','doola','dreamgames','drivetrain','dynamic-set-dollar','educative','elfbeauty','elrond','emma-sleep','employ',
  'empty-set-dollar','enable','enjin','equativ','erg','esper','eternal','eventbrite','everbridge','everlywell',
  'factor','fampay','fantom','farfetch','fetchrewards','fevo','fi','field-ai','filecoin','finch',
  'find','finn','floqast','flow','foundation','frax','freedompay','fresha','frontify','ftx',
  'gala','gearset','gemini','getlabs','gettyimages','getwingapp','glassdoor','globalentry','gohighlevel','goodleap',
  'gopuff','goswift','greenlight','gridware','groupon','grubhub','h1','happyco','happyhiller','harmony',
  'harvestfinance','hcvt','healthcare','heartbeathealth','helium','highspot','hightechhigh','hive','honey','hostinger',
  'houzz','huobi','ibotta','illuvium','imentor','immutable','imo-online','includedhealth','inductivehealth','influur',
  'investorflow','ioconnectservices.com','ion','ivo','jetbrains','jobandtalent','jumpcloud','kabam','kepler','kiddom',
  'klivvr','kpler','kraken','kraken123','kubra','kucoin','kyber','labelbox','ladders','lalamove',
  'lamudi','lendbuzz','levelai','levelup','lever','leverdemo-8','livepeer','loadsmart','logz','loopring',
  'lucidworks','lumivero','lumotive','lyrahealth','mactores','mahmee','makerdao','masterycharter','matchgroup','matillion',
  'medium','meesho','megaport','mendix','merklescience','metabase','metaprise.ai','metopera','metr','mina',
  'mindbloom','mindtickle','mistral','nava','nba-top-shot','near','neighbor','netflix','netomi','newton',
  'nexo','nielsen','nifty-gateway','nimblerx','ninjavan','nium','nominal','novatalent','numeris','offchainlabs',
  'okx','olympusdao','omnisend','opensea','outreach','palantir','palo-it','pancakeswap','patsnap','pattern',
  'paxos','paytm','pditechnologies','peakgames','penumbrainc','people-ai','perforce','petvisor','picklerobot','pipedrive',
  'pivotal','placemakr','plaid','planettechnologies','planner5d','plexus','plusgrade','pointclickcare','polkadot','polygon',
  'postmates','pp-la','ppfa','ppgny','precheck','prismic','proof','proper','prosper','protective',
  'protolabs','provi','quantcast','quantummetric','questanalytics','quokka','rackspace','rakuten','rarible','redsox',
  'regrello','relay','retailmenot','revel','revhealth','rhombus-systems','rise','rivr','ro','robust-ai',
  'rover','safe','sanctuary','sandbox','saviynt','seamless','sensortower','shieldai','shipt','shopback-2',
  'signal','singerlewak','slickdeals','smart-working-solutions','snaplogic','solana','sonatype','sorare','spell','spotify',
  'sprucesystems','stackblitz','stacks','standtogether','staratlas','suger','supermove','superrare','superside','sure',
  'sushiswap','swordhealth','synthetix','sysdig','tala','taskrabbit','teamsnap','tecton','teikametrics','teleport',
  'telesat','terra','tether','theblockcrypto','theta','thinkahead','thinkingbox','thumbtack','toku','topanga',
  'torchdental','trueml','trueusd','trunkio','trustly','tsa','ttecdigital','txidigital','unico','uniswap',
  'upguard','vacancies','veeva','vendavo','venteur','veo','vergesense','versapay','vevo','vida',
  'vivrelle','voodoo','voyager','vrchat','walkme','waveapps','wealthfront','wework','whereby','whoop',
  'willowinc','wisdomai','wonderland','workwave','wr','yearn','yelp','z1tech','zedrun','zeta',
  'zocks','zoox'
];

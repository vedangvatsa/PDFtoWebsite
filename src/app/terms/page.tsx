        ...
        <div className="prose prose-base space-y-8 text-muted-foreground">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li><strong>Future Development & Ecosystem Evolution:</strong> Because we aim to constantly evolve CVin.Bio to better serve your career growth, you also grant us permission to adapt, compile, or use uploaded professional data to develop new tools, features, or related business models over time.</li>

      ...
      <main className="flex-1 mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="prose prose-base dark:prose-invert space-y-8 text-muted-foreground">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              <li><strong>Data Ownership:</strong> You retain complete ownership of the professional details and resume data you provide. By uploading your information, you grant CVin.Bio a worldwide, non-exclusive, royalty-free license to securely host, format, display, reproduce, and distribute your data to power your unique profile URL and operate the Service.</li>
              <li><strong>Showcase &amp; Promotional License:</strong> By creating a public profile on CVin.Bio, you grant us permission to feature your profile, profile link, or anonymized excerpts of your content in our marketing materials, website showcases, case studies, social media, testimonials, and promotional campaigns. This helps us grow the platform while giving your profile increased visibility. You may opt out of promotional use at any time by deleting your account.</li>
              <li><strong>Proactive Matchmaking:</strong> To actively help you land your next big role, we may surface your profile to verified hiring partners within our network. You maintain control over this visibility. If you prefer to remove your profile from our network completely, you can revoke this access by permanently deleting your account and all associated data through your dashboard settings.</li>

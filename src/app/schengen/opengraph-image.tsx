      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'row', gap: 16 }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1, backgroundColor: '#ffffff', border: '1px solid #e4e4e7', borderRadius: 12, padding: '24px' }}>
            <div style={{ fontSize: 14, color: '#71717a', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '0.05em' }}>Days Used</div>
            <div style={{ fontSize: 48, fontWeight: 800, color: '#09090b', marginTop: 8 }}>45</div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1, backgroundColor: '#ffffff', border: '1px solid #e4e4e7', borderRadius: 12, padding: '24px' }}>
            <div style={{ fontSize: 14, color: '#71717a', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '0.05em' }}>Days Left</div>
            <div style={{ fontSize: 48, fontWeight: 800, color: '#16a34a', marginTop: 8 }}>45</div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1, backgroundColor: '#ffffff', border: '1px solid #e4e4e7', borderRadius: 12, padding: '24px' }}>
            <div style={{ fontSize: 14, color: '#71717a', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '0.05em' }}>Window Resets</div>
            <div style={{ fontSize: 48, fontWeight: 800, color: '#09090b', marginTop: 8 }}>Sep 15</div>
          </div>
        </div>

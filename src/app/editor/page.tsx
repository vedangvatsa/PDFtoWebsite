        ...
        <div className="flex min-h-screen flex-col overflow-x-hidden">
            ...
            {!user && (
                <div className="bg-amber-50 border-b border-amber-200 px-4 py-2.5 flex flex-wrap items-center justify-center gap-2 sm:gap-3 text-amber-800 text-xs md:text-sm">
                    ...
                    <LoginDialog allowSignup trigger={
                                    ...
                                    <div className="flex flex-col md:flex-row gap-6 md:items-center">
                                        ...
                                        <div className="flex-1 w-full space-y-2">
                                            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-6 gap-x-3 gap-y-2.5">
                                                ...
                                                <div className="space-y-1 sm:col-span-1 xl:col-span-4"><Label htmlFor="email" className="text-xs">Email</Label><Input id="email" name="email" type="email" value={profile.email || ''} onChange={handleProfileChange} onBlur={handleProfileBlur} className={`h-9 ${(profile.email || '').match(/^(https?:\/\/|www\.)/) ? 'border-red-400 focus-visible:ring-red-400' : ''}`} />{(profile.email || '').match(/^(https?:\/\/|www\.)/) && <p className="text-[11px] text-red-500 mt-0.5">This is an email field, not a URL. Remove &quot;www.&quot; prefix.</p>}</div>

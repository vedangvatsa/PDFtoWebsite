...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    description_for_human: 'Convert your CV to a professional website. Browse 17,000+ tech jobs at 170+ companies with AI skill matching.',
    description_for_model: 'CVin.Bio converts PDF resumes into professional web profiles and provides a job board with 17,000+ tech listings from 170+ companies (OpenAI, Stripe, Anthropic, Cloudflare, etc). Use this to find tech jobs, company career pages, or information about the tech job market. The site also publishes research reports on tech hiring trends, layoffs, and remote work.',
    auth: { type: 'none' },
    api: {
      type: 'openapi',

...
import { Cite, DonutChart, HBar, VBar, BubbleChart, BigNum, Callout, Sources } from '@/components/report/charts';
    ...
    <div className="space-y-3">
      {data.map((d, i) => (
        <div key={i} className="flex items-center gap-2">
          <span className="text-[11px] text-zinc-600 w-20 shrink-0 text-right">{d.label}</span>
          <div className="flex-1 relative h-1 bg-zinc-100 rounded-full">
            ...
            <div className="absolute rounded-full border-2 border-white" style={{ left: `${(d.value / max) * 100}%`, top: '-4px', width: 10, height: 10, backgroundColor: d.color, transform: 'translateX(-5px)' }} />
          </div>
          <span className="text-[11px] font-bold text-zinc-800 w-10 shrink-0">{d.value}{unit}</span>
        </div>
      ))}
    </div>
  );
      ...
      {regions.map((r, i) => (
        <div key={i}>
          <div className="flex justify-between mb-1.5">
            <span className="text-sm text-zinc-700 font-medium">{r.name}</span>
          </div>
...
function RegionCards() {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
      {regions.map((r, i) => (
        <div key={i} className="bg-white border border-zinc-200 rounded-xl p-5 hover:border-zinc-400 transition-colors">
          <div className="flex items-baseline justify-between mb-3">
            <span className="text-base font-bold text-zinc-900">{r.name}</span>
            <span className="text-[11px] text-zinc-400 font-medium">{r.roles} roles</span>
          </div>
          <p className="text-[13px] text-zinc-600 font-medium mb-1">Top function: {r.top}</p>
          <p className="text-[11px] text-zinc-400 mt-2 italic">{r.note}</p>
        </div>
      ))}
    </div>
  );
      ...
      <svg viewBox="0 0 300 300" className="w-full h-full" aria-hidden="true">
        {dots.map((d, i) => (
          <circle key={i} cx={d.x} cy={d.y} r={d.r}
            className="hero-particle fill-zinc-800"
  ...
  return (
    <svg viewBox="0 0 300 280" fill="none" className="w-full h-auto max-w-xs mx-auto" aria-hidden="true">
      {[0.25, 0.5, 0.75, 1].map((f, i) => (
        <circle key={i} cx={cx} cy={cy} r={maxR * f} className="stroke-zinc-200" strokeWidth="0.5" fill="none" />
      ))}
      {skills.map((s, i) => {
        ...
        return (
          <g key={i}>
            <line x1={cx} y1={cy} x2={cx + Math.cos(angle) * maxR} y2={cy + Math.sin(angle) * maxR} className="stroke-zinc-200" strokeWidth="0.5" />
            <circle cx={x} cy={y} r="4" className="fill-zinc-900" />
            <text x={lx} y={ly + 4} textAnchor="middle" className="fill-zinc-500 text-[9px]" fontFamily="inherit">{s.name}</text>
          </g>
        );
      })}
      <polygon
        ...
        className="fill-zinc-900/10 stroke-zinc-900"
        strokeWidth="1.5"
      />
    </svg>
  );
  ...
  return (
    <div className="h-screen overflow-y-auto bg-[#fafafa] selection:bg-zinc-200 transition-colors duration-200 flex flex-col">
      ...
      <main id="main-content" className={PAGE_CONTAINER}>
        ...
        <section className="mb-28">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16 items-center">
            <div className="lg:col-span-3">
              <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">85% of tech roles still require you to show up</h2>
            ...
            <div className="lg:col-span-2 flex items-center">
              <div className="bg-white border border-zinc-200 rounded-2xl p-6 w-full">
                <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-5 text-center">Work arrangement</p>
                <DonutChart segments={[
          ...
          <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
            <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Breakdown of remote roles by function</p>
            <HBar data={[
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">Every region has a different hiring personality</h2>
          <p className="text-[15px] text-zinc-500 leading-[1.85] mb-8">
          ...
          <div className="bg-white border border-zinc-200 rounded-2xl p-8 mt-6">
            <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Role mix comparison by region (% of listings)</p>
            <StackedRegionBars />
          </div>
        ...
        <section className="mb-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">1 in 3 listings is for a software engineer</h2>
              <p className="text-[15px] text-zinc-500 leading-[1.85] mb-5">
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Role distribution (% of listings)</p>
              <HBar data={[
        ...
        {/* SECTION 4: SENIORITY */}
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">Only 2.7% of roles are for new grads</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              <p className="text-[15px] text-zinc-500 leading-[1.85] mb-5">
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-5 text-center">Seniority distribution</p>
              <DonutChart segments={[
        ...
        {/* SECTION 5: SKILLS */}
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">25% of listings require AI or ML skills</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              <p className="text-[15px] text-zinc-500 leading-[1.85] mb-5">
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Skill demand (% of all listings)</p>
              <SkillRadarChart />
            </div>
          </div>

          <div className="bg-white border border-zinc-200 rounded-2xl p-8 mt-10">
            <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Most tagged skills</p>
            <HBar data={[
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">The True Demand: Live Tag Extraction</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              <p className="text-[15px] text-zinc-500 leading-[1.85] mb-5">
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Top Tags (Live Crawl Data)</p>
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">Go is the most tagged language, not Python</h2>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-5">
            <p className="text-[15px] text-zinc-500 leading-[1.85] lg:col-span-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">Languages by tag frequency</p>
              <HBar data={[
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">Niche but notable</p>
              <HBar data={[
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">Backend engineers are 2x more common than frontend</h2>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-5">
            <p className="text-[15px] text-zinc-500 leading-[1.85] lg:col-span-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">Engineering specializations (% of titles)</p>
              <HBar data={[
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">Remote rate by specialization</p>
              <HBar data={[
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">AI requirements vary wildly by function</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              <p className="text-[15px] text-zinc-500 leading-[1.85] mb-5">
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">AI/ML requirement by function</p>
              <BubbleChart data={[
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Most common skill pairs (co-occurrence)</p>
              <HBar data={[
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Remote % by seniority</p>
              <HBar data={[
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">&ldquo;GenAI Engineer&rdquo; is now a distinct job category</h2>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-5">
            <p className="text-[15px] text-zinc-500 leading-[1.85] lg:col-span-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">AI title categories (% of listings)</p>
              <HBar data={[
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">GenAI/LLM title density by region</p>
              <HBar data={[
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">Kubernetes and Snowflake are the most in-demand tools</h2>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-5">
            <p className="text-[15px] text-zinc-500 leading-[1.85] lg:col-span-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">Top frameworks and tools (% of tagged listings)</p>
              <HBar data={[
            ...
            <div className="space-y-6">
              <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
                <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">AI/ML tooling (% of tagged listings)</p>
                <HBar data={[
              ...
              <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
                <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-3">Cloud platform leader by region</p>
                <div className="space-y-2 text-[13px]">
                  {[
                    ...
                    <div key={i} className="flex justify-between items-center py-1 border-b border-zinc-100">
                      <span className="text-zinc-600">{row.r}</span>
                      <span className="font-bold text-zinc-900">{row.leader} <span className="font-normal text-zinc-400">{row.pct}</span></span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">AI labs and fintech are scaling the fastest</h2>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-5">
            <p className="text-[15px] text-zinc-500 leading-[1.85] lg:col-span-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">Hiring by sector (among tracked companies)</p>
              <HBar data={[
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">AI net hiring effect (LF 2025)</p>
              <HBar data={[
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">What each region actually hires for</h2>
          <p className="text-[15px] text-zinc-500 leading-[1.85] mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">USA top skill tags</p>
              <HBar data={[
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">UK top skill tags</p>
              <HBar data={[
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Singapore top tags</p>
              <HBar data={[
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">India top tags</p>
              <HBar data={[
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Japan top tags</p>
              <HBar data={[
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">AI tag penetration by region</p>
              <HBar data={[
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-4">Mobile tag density by region</p>
              <HBar data={[
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-10">Eight patterns in the data</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-10">
            {[
              ...
              <div key={i} className="flex gap-5">
                <span className="text-4xl font-serif font-bold text-zinc-200 w-14 shrink-0 leading-none pt-0.5">{item.n}</span>
                <div>
        ...
        {/* METHODOLOGY */}
        <section className="mb-24 pt-8 border-t border-zinc-200">
          <h2 className="text-lg font-serif font-bold tracking-tight text-zinc-900 mb-4">Methodology</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">

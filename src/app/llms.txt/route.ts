...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    `- Cost of Living: ${siteUrl}/costs`,
    `- Compare Cities: ${siteUrl}/compare`,
    `- Nomad Visas: ${siteUrl}/visas`,
    `- Internet Speeds: ${siteUrl}/wifi`,
    `- Visa Checker: ${siteUrl}/passport`,
    `- Resources: ${siteUrl}/resources`,
    `- Climate Finder: ${siteUrl}/climate`,
    `- FIRE / Savings Runway Calculator: ${siteUrl}/fire`,
    `- Nomad Insurance Comparison: ${siteUrl}/insurance`,
    `- City Safety Rankings: ${siteUrl}/safety`,
    `- Purchasing Power Calculator: ${siteUrl}/salary`,

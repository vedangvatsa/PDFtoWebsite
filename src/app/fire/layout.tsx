...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'FIRE Calculator — Savings Runway by City', description: 'How long will your savings last in 95 nomad cities?', url: `${siteUrl}/fire`, siteName: 'CVin.Bio', type: 'website' },
};

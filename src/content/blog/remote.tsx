...
export default function ArticleContent() {
  return (
    <div className="flex flex-col gap-6 text-lg text-zinc-800 dark:text-zinc-300 transition-colors leading-relaxed">
      ...
      <p>
        Describe how you optimized your deployment schedules to minimize system downtime. 
      ...
      <h2 className={h2}>Highlighting Async Documentation Skills</h2>
      <p>
      ...
      <ul className={ul}>
        <li><Link href="/mobile" className={link}>Optimizing CV layouts for mobile devices</Link></li>

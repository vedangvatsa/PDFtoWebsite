...
import { h2, callout, ul, bold, link } from '@/lib/blog-styles';
...
export default function ArticleContent() {
 ...
 It proves you can tune applications at scale.
 </p>
 ...
 Make sure it is sharp, readable, and backed by hard metrics.
      ...
      <h2 className={h2}>Tailoring Summaries Without Starting From Scratch</h2>
      <p>
 Senior engineers often resist rewriting their summary for every application. That is reasonable. You do not need a completely new paragraph each time. Keep a master version with your strongest metrics, then swap one sentence to match the target role.
 </p>
      <p>
 If you are applying to a platform team, lead with infrastructure scale. If you are applying to a product team, lead with user-facing latency wins. The other two sentences can stay identical. This takes five minutes per application instead of thirty, and it still signals that you read the job description.
 </p>
      <p>
 Store these variants on your web profile if the platform supports multiple summary blocks. Some candidates maintain a default public summary and a private link with a tailored version for a specific company. Either way, the goal is the same: make the first three sentences feel written for the reader in front of you.
 </p>

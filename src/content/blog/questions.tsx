...
export default function ArticleContent() {
  return (
    <div className="space-y-6 text-lg text-zinc-800 dark:text-zinc-300 transition-colors leading-relaxed">
      ...
      <p>
        If you are explaining your own experience with pipelines look at the <Link href="/system-design" className={link}>best ways to prove system design skills</Link> to structure your descriptions. Highlighting your past pipeline wins builds technical trust.
      </p>
      <p>

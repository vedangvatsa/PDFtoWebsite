  ...
  return (
    <div className="flex flex-col gap-6 text-lg text-zinc-800 dark:text-zinc-300 transition-colors leading-relaxed">
      ...
      <p>
        ...
        Do not just claim you know a tool. 
        Show exactly how you used that tool to optimize a production system. 
      ...
      <p>
        Semantic tags also improve search engine optimization. 
      ...
      <ul className={ul}>
        ...
        <li><Link href="/mobile" className={link}>Optimizing your document for mobile screens</Link></li>

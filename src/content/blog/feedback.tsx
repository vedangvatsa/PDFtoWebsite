...
export default function ArticleContent() {
  return (
    <div className="space-y-6 text-lg text-zinc-800 dark:text-zinc-300 transition-colors leading-relaxed">
      ...
      <p>
        This gesture shows you understand that feedback is a professional transaction. It proves you are not just looking for a free handout. Even if they decline your help they will remember your professional attitude.
      </p>
      <p>
      ...
      <p>
        If a senior engineer takes the time to write a detailed reply you must show that you used their advice. Do not just say thank you and do nothing.
      </p>
      <p>

  ...
  return (
    <div className="flex flex-col gap-6 text-lg text-zinc-800 dark:text-zinc-300 transition-colors leading-relaxed">
      ...
      <p>
        ...
        However, if you do not showcase these contributions correctly, they remain invisible.
      </p>
      ...
      <p>
        For instance, write "Optimized core HTTP client caching mechanics in the library to reduce memory allocations by thirty percent." 

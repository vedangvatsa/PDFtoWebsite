...
export default function ArticleContent() {
 ...
 Ashby has rapidly become the favorite tracking system for fast-growing technology companies. It features a highly advanced parser that rarely makes errors when scraping text. Ashby focuses on speed and gives recruiters powerful filters to sort candidates by specific technical achievements.
      ...
      <p>
 Because Ashby users are usually scaling quickly, they filter profiles aggressively. They build custom pipelines that look for specific database or system tuning experience. Your profile must highlight these achievements clearly in your project details.
 </p>
 ...
 To learn more about how tracking systems process your document, read our guide on how to <Link href="/screening" className={link}>get past AI screening</Link>. If you want to know why complex designs fail, check out our analysis of <Link href="/pdf" className={link}>why complex PDFs break algorithms</Link> in modern recruitment. If you want to use a dual submission approach, read about <Link href="/bypass" className={link}>formatting destruction and dual submissions</Link> to secure your layout.
      ...
      <h2 className={h2}>How to Identify Which ATS You Are Facing</h2>
      <p>
 Look at the application URL. Workday portals usually contain myworkdayjobs.com or wd1.myworkdaysite.com. Greenhouse URLs often include boards.greenhouse.io. Lever uses jobs.lever.co. Ashby uses jobs.ashbyhq.com. Taleo URLs frequently contain taleo.net.
 </p>
      <p>
 Browser extensions like ATS Detector can flag the platform automatically when you land on an application page. Knowing the system before you upload lets you pick the right file format and layout strategy.
 </p>
      <p>
 If the portal asks you to create an account and manually retype your entire work history, you are probably on Workday or Taleo. If it accepts a single file upload and moves on, you are likely on Greenhouse, Lever, or Ashby.
 </p>

      <h2 className={h2}>iCIMS, SmartRecruiters, and BambooHR</h2>
      <p>
 iCIMS is common among mid-size companies and staffing firms. It parses.docx reasonably well but struggles with PDFs that use custom fonts. Submit.docx with Arial or Calibri and standard section headers.
 </p>
      <p>
 SmartRecruiters powers many European companies. It indexes skills aggressively and displays them in a sidebar for recruiters. Put your core technologies in a dedicated Skills section, not buried inside bullet points.
 </p>
      <p>
 BambooHR is popular with smaller companies that handle hiring internally. The parser is basic. Keep your layout extremely simple. One column, standard headings, no graphics. The recruiter often sees a plain text extraction alongside your uploaded file.
 </p>

      <div className={callout}>
        <h3 className={h3}>The website field trick</h3>
        <p>
 Almost every ATS has a website or portfolio URL field. Fill it with your web profile link even when you also upload a file. Recruiters click the link when the parsed version looks wrong. This single field saves more applications than any formatting tweak.
 </p>
      </div>

...
export default function ArticleContent() {
 ...
 Do not start with a request. Start with something you have in common. Mention a technical post they wrote, a public project they contribute to, or a mutual colleague. This breaks the ice and shows that you are active in the developer community.
      ...
      <p>
 Next, state your value quickly. Do not list your job titles. State a specific problem you solved that relates to their team. If they work on database scaling, mention how you tuned slow queries at your last job. Use concrete numbers.
 </p>
      <p>
 ...
 When you make it easy for the engineer to review your code, you reduce the friction of the referral process. They can skim your work in thirty seconds and feel confident recommending you to their manager. For more strategies on setting up your online presence, read our guide on <Link href="/linkedin" className={link}>LinkedIn alternatives for developers</Link>.
      ...
      <h2 className={h2}>The Two Week Warm-Up Before You Ask</h2>
      <p>
 The highest conversion referral requests come from people who interacted with you before the ask. Comment on their technical post with a specific observation. Share a small code experiment inspired by their architecture blog. Reply to their question in a public thread with a working solution and a link to your profile.
 </p>
      <p>
 After two or three genuine interactions spread across a week or two, your name is no longer random. When you send a short message mentioning the open role, the engineer recognizes you. The referral feels like recommending a peer they have already vetted, not gambling on a stranger who appeared in their inbox overnight.
 </p>
      <p>
 This timeline requires patience. It is slower than blasting fifty connection requests. It also produces referrals that actually convert to interviews because the referring engineer can speak to your work with specifics instead of forwarding a generic resume they never reviewed.
 </p>

...
export default function ArticleContent() {
 ...
 This strategy keeps your message light. It reduces the steps between their inbox and your work history. It shows respect for their time and technical authority. For more advice on this, check out our guide on <Link href="/send" className={link}>how to send your CV to recruiters</Link>.
      ...
      <h2 className={h2}>Subject Lines for Follow-Up Emails</h2>
      <p>
 Your first email subject line gets the open. Your follow-up subject line gets the reply. Do not reuse the exact same subject when you send a second message three days later. The recruiter may think it is a duplicate and archive it without reading. Add context instead: "Re: React perf fix / added benchmark results" tells them this thread has new information.
 </p>
      <p>
 Keep follow-up subjects even shorter than your opener. The recipient already knows who you are. They need a reason to reopen the thread. A new metric, a link to a deployed fix, or a reference to a company blog post they published since your last email all work. Generic lines like "Following up on my application" get ignored because they signal zero new value.
 </p>
      <p>
 Match the tone of your first subject. If you opened with lowercase informal syntax, keep that style. Switching to formal corporate language in a follow-up feels like a different person wrote the email. Consistency builds the impression that you are one coherent professional, not a template bot.
 </p>

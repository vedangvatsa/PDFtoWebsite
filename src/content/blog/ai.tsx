...
export default function ArticleContent() {
  return (
    <div className="space-y-6 text-lg text-zinc-800 dark:text-zinc-300 transition-colors leading-relaxed">
        ...
        <p>If you were running a business in 2010 and your website was not indexed by Google, you were invisible to anyone who searched for your product. The businesses that understood this early tuned their sites with proper meta tags, semantic HTML, and structured data. The ones that did not lost a decade of organic discovery to competitors who did.</p>

        ...
        Array.from({ length: 12 }).map((_, col) => {
          ...
          return (
            <circle
              ...
              className={isHighlighted ? 'fill-zinc-900' : isSecondary ? 'fill-zinc-400' : 'fill-zinc-200'}
            />
          );
        })
      )}
      <line x1="96" y1="20" x2="58" y2="58" className="stroke-zinc-300" strokeWidth="1" strokeDasharray="3 3" />
      <line x1="286" y1="20" x2="361" y2="58" className="stroke-zinc-300" strokeWidth="1" strokeDasharray="3 3" />
      <line x1="58" y1="58" x2="172" y2="58" className="stroke-zinc-300" strokeWidth="1" strokeDasharray="3 3" />
      <line x1="248" y1="96" x2="324" y2="96" className="stroke-zinc-300" strokeWidth="1" strokeDasharray="3 3" />
      <line x1="96" y1="134" x2="210" y2="134" className="stroke-zinc-300" strokeWidth="1" strokeDasharray="3 3" />
      <line x1="172" y1="172" x2="361" y2="172" className="stroke-zinc-300" strokeWidth="1" strokeDasharray="3 3" />
    </svg>
  );
}
...
function TrendlineIllustration() {
  return (
    <svg viewBox="0 0 400 160" fill="none" className="w-full h-auto" aria-hidden="true">
      <text x="0" y="18" className="fill-zinc-400 text-[10px]" fontFamily="inherit">30%</text>
      <text x="0" y="58" className="fill-zinc-400 text-[10px]" fontFamily="inherit">20%</text>
      <text x="0" y="98" className="fill-zinc-400 text-[10px]" fontFamily="inherit">10%</text>
      <text x="0" y="138" className="fill-zinc-400 text-[10px]" fontFamily="inherit">0%</text>
      <line x1="30" y1="15" x2="390" y2="15" className="stroke-zinc-100" strokeWidth="0.5" />
      <line x1="30" y1="55" x2="390" y2="55" className="stroke-zinc-100" strokeWidth="0.5" />
      <line x1="30" y1="95" x2="390" y2="95" className="stroke-zinc-100" strokeWidth="0.5" />
      <line x1="30" y1="135" x2="390" y2="135" className="stroke-zinc-100" strokeWidth="0.5" />
      <polyline
      ...
      <polygon
        ...
        className="fill-zinc-900/5"
      />
      <text x="35" y="152" className="fill-zinc-400 text-[10px]" fontFamily="inherit">2019</text>
      <text x="110" y="152" className="fill-zinc-400 text-[10px]" fontFamily="inherit">2020</text>
      <text x="195" y="152" className="fill-zinc-400 text-[10px]" fontFamily="inherit">2022</text>
      <text x="280" y="152" className="fill-zinc-400 text-[10px]" fontFamily="inherit">2024</text>
      <text x="355" y="152" className="fill-zinc-400 text-[10px]" fontFamily="inherit">2026</text>
      <circle cx="390" cy="27" r="4" className="fill-zinc-900" />
      <text x="330" y="18" className="fill-zinc-700 text-[11px] font-semibold" fontFamily="inherit">27%</text>
    </svg>
  );
}
...
function CompensationIllustration() {
  return (
    <svg viewBox="0 0 400 120" fill="none" className="w-full h-auto" aria-hidden="true">
      <rect x="20" y="15" width="160" height="90" rx="12" className="fill-white stroke-zinc-200" strokeWidth="1" />
      <rect x="220" y="15" width="160" height="90" rx="12" className="fill-zinc-900" />
      <text x="100" y="42" textAnchor="middle" className="fill-zinc-400 text-[10px] uppercase tracking-widest" fontFamily="inherit">On-Site</text>
      <text x="100" y="74" textAnchor="middle" className="fill-zinc-700 text-[22px] font-bold" fontFamily="inherit">$142K</text>
      <text x="100" y="92" textAnchor="middle" className="fill-zinc-400 text-[10px]" fontFamily="inherit">median base</text>
      <text x="300" y="42" textAnchor="middle" className="fill-zinc-400 text-[10px] uppercase tracking-widest" fontFamily="inherit">Remote</text>
      <text x="300" y="74" textAnchor="middle" className="fill-white text-[22px] font-bold" fontFamily="inherit">$152K</text>
      <text x="300" y="92" textAnchor="middle" className="fill-zinc-400 text-[10px]" fontFamily="inherit">+7% premium</text>
      <line x1="188" y1="60" x2="212" y2="60" className="stroke-zinc-300" strokeWidth="1.5" />
      <polygon points="212,56 220,60 212,64" className="fill-zinc-300" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 400 100" fill="none" className="w-full h-auto" aria-hidden="true">
      {Array.from({ length: 10 }).map((_, i) => {
        ...
        return (
          <g key={i}>
            <circle cx={x} cy="30" r="10" className={filled ? 'fill-zinc-900' : partial ? 'fill-zinc-400' : 'fill-zinc-200'} />
            <rect x={x - 10} y="45" width="20" height="25" rx="6" className={filled ? 'fill-zinc-900' : partial ? 'fill-zinc-400' : 'fill-zinc-200'} />
          </g>
        );
      })}
      <text x="22" y="90" className="fill-zinc-700 text-[11px] font-semibold" fontFamily="inherit">12% implemented RTO</text>
      <text x="290" y="90" className="fill-zinc-400 text-[11px]" fontFamily="inherit">88% did not</text>
    </svg>
  );
}
...
export default function TalentClient() {
  ...
  const topLoc2 = stats?.topLocations?.[3];
  const topLoc3 = stats?.topLocations?.[4];
      ...
      <main id="main-content" className={PAGE_CONTAINER}>
        ...
        <section className="mb-28">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
            <div className="lg:col-span-3">
              <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">The remote work contraction is real</h2>
            ...
            <div className="lg:col-span-2 flex items-center">
              <div className="bg-white border border-zinc-200 rounded-2xl p-6 w-full h-full flex flex-col justify-center">
                <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-5 text-center">Where knowledge workers work</p>
                <DonutChart segments={[
          ...
          <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
            <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Share of paid work days at home, U.S. full-time workers</p>
        ...
        {!unlocked && !checkingAccess && (
          <div className="relative mb-28">
            <div className="select-none pointer-events-none" aria-hidden="true" style={{ filter: 'blur(6px)', opacity: 0.4 }}>
              <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">Remote hiring is concentrated in specific industries</h2>
              <p className="text-[15px] text-zinc-500 leading-[1.85] mb-5">
              ...
              <div className="grid grid-cols-2 gap-10 mb-8">
                <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-48" />
                <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-48" />
              </div>
              <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">Remote roles now pay more, not less</h2>
              <p className="text-[15px] text-zinc-500 leading-[1.85]">
        ...
        <section className="mb-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">Remote hiring is flattening across departments</h2>
              <p className="text-[15px] text-zinc-500 leading-[1.85] mb-5">
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Share of remote-eligible postings</p>
              <HBar data={[
        ...
        <section className="mb-28">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">Remote premium by role</p>
              <HBar data={[
        ...
        <section className="mb-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">Return-to-office mandates are louder than they are effective</h2>
              <p className="text-[15px] text-zinc-500 leading-[1.85] mb-5">
            ...
            <div>
              <div className="bg-white border border-zinc-200 rounded-2xl p-8 mb-4">
                <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6 text-center">Of 10 executives with remote teams, how many mandated RTO?</p>
                <OfficeVsRemoteIllustration />
              </div>
              <div className="grid grid-cols-3 gap-px bg-zinc-200 rounded-2xl overflow-hidden">
                {[
                  ...
                  <a key={i} href={d.href} target="_blank" rel="noopener noreferrer" className="bg-[#fafafa] p-5 text-center hover:bg-white transition-colors">
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">The productivity debate is settled</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              <p className="text-[15px] text-zinc-500 leading-[1.85] mb-5">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-px bg-zinc-200 rounded-2xl overflow-hidden">
            {[
              ...
              <div key={i} className="bg-[#fafafa] p-8 text-center">
                <div className="text-3xl sm:text-4xl font-serif font-bold text-zinc-900">{d.value}</div>
                <div className="text-[11px] text-zinc-400 mt-2 whitespace-pre-line">{d.label}</div>
              </div>
            ))}
          </div>
          <Sources>
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-5">What we see in our own data</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6 text-center">Listings by work arrangement</p>
              <DonutChart
                size={180}
                segments={[
                  { label: 'On-Site', value: 85, color: '#18181B' },
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 h-full flex flex-col justify-center">
              <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">% fully remote by department</p>
              <HBar data={[
                { label: 'Engineering', value: 16, color: '#18181B' },
                { label: 'Design', value: 16, color: '#3F3F46' },
        ...
        <section className="mb-28">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-10">Five things that will matter most in the next 18 months</h2>
        ...
        <section className="text-center mb-16">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-zinc-900 mb-4">Get the full report</h2>

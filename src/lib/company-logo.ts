...
const LOGO_OVERRIDES: Record<string, string> = {
  ...
  skydio: 'https://www.skydio.com/favicon.ico',
  'snorkel ai': 'https://snorkel.ai/favicon.ico',
  'snorkel-ai': 'https://snorkel.ai/favicon.ico',
  higharc: 'https://www.higharc.com/favicon.ico',
  waymo: 'https://waymo.com/favicon.ico',
  coreweave: 'https://www.coreweave.com/favicon.ico',
  fin: 'https://fin.ai/favicon.ico',
  phil: 'https://www.phil.us/favicon.ico',
  aiwyn: 'https://www.aiwyn.ai/favicon.ico',
  'clasp-group': 'https://www.clasp.com/favicon.ico',
  sambanova: 'https://sambanova.ai/favicon.ico',
  civilgrid: 'https://www.civilgrid.com/favicon.ico',
  clubhouse: 'https://www.clubhouse.com/favicon.ico',
  kodex: 'https://www.kodexglobal.com/favicon.ico',
  lambda: 'https://lambda.ai/favicon.ico',
  lendable: 'https://www.lendable.co.uk/favicon.ico',
  mudflap: 'https://www.mudflapinc.com/favicon.ico',
  pathai: 'https://www.pathai.com/favicon.ico',
  synthesia: 'https://www.synthesia.io/favicon.ico',
  expressable: 'https://www.expressable.com/favicon.ico',
  eyebot: 'https://www.eyebot.co/favicon.ico',
  reka: 'https://www.reka.ai/favicon.ico',
  texture: 'https://www.texturehq.com/favicon.ico',
...
const DOMAIN_OVERRIDES: Record<string, string> = {
  ...
  phil: 'phil.us',
  aiwyn: 'aiwyn.ai',
  'clasp-group': 'clasp.com',
  sambanova: 'sambanova.ai',
  civilgrid: 'civilgrid.com',
  clubhouse: 'clubhouse.com',
  kodex: 'kodexglobal.com',
  lambda: 'lambda.ai',
  lendable: 'lendable.co.uk',
  mudflap: 'mudflapinc.com',
  pathai: 'pathai.com',
  synthesia: 'synthesia.io',
  expressable: 'expressable.com',
  eyebot: 'eyebot.co',
  reka: 'reka.ai',
  texture: 'texturehq.com',
